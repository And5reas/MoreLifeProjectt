...
def main_screen():
    ...
    ent_email = Entry(font=("Arial", 11), width=27)
    lbl_password_ori = Label(text="Senha: ")
    ent_password = Entry(font=("Arial", 11), width=27,  show='*')
    ...
    lbl_email_ori.place(x=10, y=50)
    ent_email.place(x=50, y=50)
    lbl_password_ori.place(x=10, y=80)
    ent_password.place(x=50, y=80)
